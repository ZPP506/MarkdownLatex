...
import WebKit
    ...
    public struct MarkdownWebView: PlatformViewRepresentable {
        ...
        var onHeightChange: ((CGFloat) -> Void)? // 添加高度回调

        public init(_ markdownContent: String, customStylesheet: String? = nil, onHeightChange: ((CGFloat) -> Void)? = nil) {
        ...
        public func makeCoordinator() -> Coordinator {
              ...
              coordinator.heightChangeHandler = onHeightChange // 将回调赋值给 Coordinator
              return coordinator
          }
        #if os(macOS)
        ...
        public class Coordinator: NSObject, WKNavigationDelegate, WKScriptMessageHandler {
            ...
            var heightChangeHandler: ((CGFloat) -> Void)? // 添加高度回调
            ...
            public func userContentController(_: WKUserContentController, didReceive message: WKScriptMessage) {
                ...
                case "sizeChangeHandler":
                    ...
                    // 调用高度变化的回调
                    heightChangeHandler?(contentHeight)
